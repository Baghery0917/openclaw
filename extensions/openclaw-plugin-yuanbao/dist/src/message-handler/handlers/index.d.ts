...
import type { Member } from '../../module/member.js';
...
export declare function prepareOutboundContent(text: string, groupCode?: string, memberInst?: Member): OutboundContentItem[];
